...
public class EnemyAI : MonoBehaviour
{
    ...
    //Enemy의 움직임을 제어하는 MoveAgent스크립트 가져오기
    MoveAgent moveAgent;
    EnemyFire enemyFire;
    EnemyFOV enemyFOV;
    ...
    {
        //코루틴 함수는 반드시 StartCorutine을 통해서 실행
        StartCoroutine(CheckState());
        StartCoroutine(Action());
        //Damage 스크립트에 있는 정적 이벤트에 
        //EnemyAl 스크립트의 E_PlayerDie메소드를 연결 시켜줌
        //이벤트 연결 시에는 += 뺄때는 -= 을 씀
    ...
    {
        //오브젝트 풀 등 여러스크립트 들이 준비가 끝날 떄 까지 잠시 대기
